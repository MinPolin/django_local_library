...
from catalog.models import Author,User,Genre,Language,Book,BookInstance
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_another_users_borrowed_book(self):
        ...
        resp = self.client.get(reverse('renew-book-librarian',
                                       kwargs={'pk': self.test_bookinstance1.pk, }))
        # Check that it lets us login. We're a librarian, so we can view any users
        self.assertEqual(resp.status_code, 200)
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        resp = self.client.post(reverse('renew-book-librarian',
                                        kwargs={'pk': self.test_bookinstance1.pk, }), {'renewal_date': valid_date})
...
class CreateAuthorViewTest(TestCase):
    ...
    def test_redirect_if_logged_in_but_not_correct_permission(self):
        ...
        self.assertEqual(resp.status_code, 302)
        self.assertTrue(resp.url.startswith('/accounts/login/'))
    def test_redirect_if_logged_in_with_correct_permissions(self):
        login = self.client.login(username='testuser1', password='12345')
    ...
    def test_redirects_to_authors_on_success(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.post(reverse('author-create'),{'first_name': 'Bob','last_name':'Billy'})
